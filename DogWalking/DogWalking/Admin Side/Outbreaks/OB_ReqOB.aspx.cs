...
{
    public partial class OB_ReqOB : System.Web.UI.Page
    {
        ...
        private void bindToGrid()
        {
            string sqlQuery = @"SELECT Outbreak.OutbreakID, Outbreak.OutbreakType, Outbreak.OutbreakDate, Walk.WalkName," +
                               ...
                               " Location ON Walk.LocationID = Location.LocationID WHERE NewOutbreak = 'True'";
            ...
            this.grdReqOutbreaks.DataSource = dt;
            this.grdReqOutbreaks.DataBind();
        }

        protected void grdReqOutbreaks_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session["OBID"] = this.grdReqOutbreaks.SelectedRow.Cells[1].Text;
            Session["reqOB"] = "reqOB";
